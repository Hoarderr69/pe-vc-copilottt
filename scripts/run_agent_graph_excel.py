...
def main():
    ...
    initial_state = {
        ...
        # Separate Excel/QPR artifacts so we do not overwrite EDGAR artifacts.
        "raw_feature_matrix_path": "data/features/demo_excel_qpr_feature_matrix.csv",
        "model_feature_matrix_path": "data/features/demo_excel_qpr_model_feature_matrix.csv",
        "kpi_records_path": "data/processed/excel_qpr_kpi_records.json",
        "evidence_refs_path": "data/processed/excel_qpr_evidence_refs.json",
        "source_quality_report_path": "data/processed/excel_qpr_source_quality_report.json",
        "forecast_path": "data/processed/excel_qpr_quant_ebitda_forecast.csv",
        "stl_components_path": "data/processed/excel_qpr_stl_components.csv",
        "irr_scenarios_path": "data/processed/excel_qpr_irr_scenarios.csv",
    }
    ...
    output_path = (
        ...
        / "data"
        / "processed"
        / "excel_qpr_agent_graph_state.json"
    )
    ...
    print("\n========== EXCEL/QPR GRAPH FINAL STATE SUMMARY ==========")
    ...
    print(f"- {final_state.get('forecast_path')}")
    print(f"- {final_state.get('irr_scenarios_path')}")
